...
public class GrupoAdapterPV extends BaseAdapter {
    private final ArrayList<ArrayList<MenuItem>> listas;
    private final ArrayList<String> grupos;
    private final PuntoVenta activity;

    public GrupoAdapterPV(ArrayList<ArrayList<MenuItem>> listas, ArrayList<String> grupos, PuntoVenta activity) {
        this.listas = listas;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view == null)
            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_punto_venta, viewGroup, false);

        NavigationView navigationView = activity.findViewById(R.id.navigationViewPV);
